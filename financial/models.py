...
class AccountPayable(models.Model):
    ...
    supply = models.ForeignKey('supply.Fornecedor', related_name='account_payable', on_delete=models.PROTECT, verbose_name=_('Fornecedor'))
    ...
    def clean(self):
        ...
        if self.pk:
            ...
            if invoices.exists():
                invalid_invoices = invoices.exclude(fornecedor=self.supply)
